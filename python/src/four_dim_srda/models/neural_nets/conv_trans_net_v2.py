...
from src.four_dim_srda.models.neural_nets.block.down_block import DownResBlock
from src.four_dim_srda.models.neural_nets.block.up_block import UpResBlock

logger = getLogger()


@dataclasses.dataclass
class ConvTransNetVer02Config(BaseModelConfig):
    bias: bool
    feat_channels_0: int
    feat_channels_1: int
    feat_channels_2: int
...
class ConvTransNetVer02(nn.Module):
    def __init__(
        self,
        config_ins: ConvTransNetVer02Config,
    ):
        super().__init__()
