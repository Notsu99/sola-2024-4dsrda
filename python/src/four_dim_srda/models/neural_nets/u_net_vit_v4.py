...
class UNetVitVer04Config(BaseModelConfig):
    bias: bool
    input_channels: int
    feat_channels_0: int
    feat_channels_1: int
...
class UNetVitVer04(nn.Module):
    def __init__(
        self,
        cfg: UNetVitVer04Config,
    ):
        #
        super().__init__()
        ...
        logger.info("U-Net ViT Ver04 is initialized")
        ...
        self.num_patch = (
            (self.latent_2d_space_shape[0] // self.cfg.patch_size_x)
            * (self.latent_2d_space_shape[1] // self.cfg.patch_size_y)
        )
