...
PY_SCRIPT_PATH=${ROOT_DIR}/python/scripts/four_dim_srda/cfd_simulation/qg_model/split_hr_training_data_in_parallel.py
...
singularity exec \
    ...
    ${IMAGE_PATH} python3 ${PY_SCRIPT_PATH} --config_path ${CONFIG_PATH}
