...
SCRIPT_PATH=${ROOT_DIR}/python/scripts/four_dim_srda/srda/evaluate_using_fixed_obs_point_and_narrow_jet_storing_only_forecast.py
...
bias${BIAS}_bs${BS_NUM}_lr${LR_NUM}.yml
