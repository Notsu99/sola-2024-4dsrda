...
if __name__ == "__main__":
    try:
        ...
        result_dir = f"{RESULT_DIR}/{experiment_name}/letkf/perform_letkf_hr_using_uhr/use_narrow_jet/{na_value}_{config_name}"
        os.makedirs(result_dir, exist_ok=True)

        log_dir = f"{LOG_DIR}/{experiment_name}/letkf/perform_letkf_hr_using_uhr/use_narrow_jet/{na_value}_{config_name}"
