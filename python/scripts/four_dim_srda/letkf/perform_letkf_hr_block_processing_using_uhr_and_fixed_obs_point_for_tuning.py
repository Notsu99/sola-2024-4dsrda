...
if __name__ == "__main__":
    try:
        ...
        result_dir = f"{RESULT_DIR}/{experiment_name}/letkf/perform_letkf_hr_using_uhr/tuning/{og_val}/{na_val}_{config_name}"
        os.makedirs(result_dir, exist_ok=True)

        log_dir = f"{LOG_DIR}/{experiment_name}/letkf/perform_letkf_hr_using_uhr/tuning/{og_val}/{na_val}_{config_name}"
        ...
        for i_seed_uhr in range(i_seed_uhr_start, cfg_cfd.seed_config.uhr_seed_end + 1):
            ...
            #
            obs_npz_file_path = f"{RESULT_DIR}/{experiment_name}/srda/{model_name}/{config_srda_name}/UHR_seed_{i_seed_uhr:05}.npz"
