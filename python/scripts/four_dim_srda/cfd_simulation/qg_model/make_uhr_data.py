...
if __name__ == "__main__":
    try:
        ...
        result_dir = f"{RESULT_DIR}/{experiment_name}/{SIMULATION_NAME}/uhr_pv"
        log_dir = f"{LOG_DIR}/{experiment_name}/{SIMULATION_NAME}/uhr_pv/{config_name}"
        ...
        for i_seed in range(
            ...
            if cfg.jet_profile == "tanh":
                ...
                u = make_jet_velocity_with_sech_squared_profile(cfg.uhr_base_config)[
                    None, ...
                ]
                ...
                u = make_jet_velocity_with_sech_squared_and_sigmoid_profile(cfg.uhr_base_config)[
                    None, ...
                ]
                noise = cfg.uhr_base_config.noise_amplitude * torch.randn(
                    size=(cfg.uhr_base_config.n_batch,) + u.shape[-3:]
