...
if __name__ == "__main__":
    try:
        ...
        log_dir = f"{LOG_DIR}/{experiment_name}/evaluation/{model_name}/use_narrow_jet/{cfg_srda_name}"
        result_dir = f"{RESULT_DIR}/{experiment_name}/srda/{model_name}/use_narrow_jet/{cfg_srda_name}"
            ...
            for i_cycle in tqdm(range(NUM_TIMES)):
                ...
                if i_cycle > 0 and i_cycle % ASSIMILATION_PERIOD == 0:
                    ...
                    all_lr_forecast += lr_forecast[0][
                        i_start // OUTPUT_SCALE_FACTOR : i_end // OUTPUT_SCALE_FACTOR
                    ]
